...
function glslLoader(options) {
    ...
    const glslifyLoadSource = async (id, source, options, failError, warnLog = console.error) => {
        ...
        let basedir = undefined(id);
        if (!undefined(basedir)) {
